...
if(Token.EOF == CurrentToken || Token.CLOSE == CurrentToken || false){
var text = new List<string>();
var myReturn = new freturn();
{myReturn.res = false;}
return myReturn;
...
if(Token.EOF == CurrentToken || Token.XOR == CurrentToken || Token.CLOSE == CurrentToken || false){
var text = new List<string>();
var myReturn = new ereturn();
{myReturn.res = false;}
return myReturn;
...
if(Token.EOF == CurrentToken || Token.XOR == CurrentToken || Token.OR == CurrentToken || Token.CLOSE == CurrentToken || false){
var text = new List<string>();
var myReturn = new dreturn();
{myReturn.res = true;}
return myReturn;
...
if(Token.VAR == CurrentToken || false){
var text = new List<string>();
var myReturn = new creturn();
text.Add(CurrentTokenString);
Next();
{myReturn.res = bool.Parse(text[0]);}
return myReturn;
} else 
if(Token.OPEN == CurrentToken || false){
var text = new List<string>();
var myReturn = new creturn();
text.Add(CurrentTokenString);
Next();
